...
class TestDownloader(unittest.TestCase):
    ...
    def test_parallelization(self):
        ...
        self.do_parallel_download(Constants.load_links(100), serialize=False)

    def test_parallelization_serialize(self):
        """ Download 100 links with multiple processes and serialization """
        self.do_parallel_download(Constants.load_links(100), serialize=True)
